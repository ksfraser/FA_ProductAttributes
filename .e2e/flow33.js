...
(async () => {
  ...
  await page.fill('input[name="description"]','E2E WW '+pk);
  ...
  const state = await page.evaluate(()=>{
    ...
    return { _tabs_sel: ts? ts.value : 'MISSING', _tabs_sel_tag: ts? ts.tagName : null, gcOuter: gc? gc.outerHTML : null, currentTabClass: (()=>{ const b=document.querySelector('button[name="tabs_product_variations"]'); return b? (b.className) : null; })() };
  });
