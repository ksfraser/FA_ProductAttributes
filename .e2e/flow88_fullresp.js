...
if(m){try{var j=JSON.parse(m[1]);var cmds=j.js||{};Object.keys(cmds).forEach(function(k){var c=cmds[k];if(c.n==='up'&&c.t==='tabs'&&c.data){console.log('=== FULL tabs update data ('+c.data.length+' chars) ===');console.log(c.data);}});}catch(e){console.log('parse err:',e.message);}}
else{console.log('NO MATCH, raw first 1000:',rawResp.slice(0,1000));}
