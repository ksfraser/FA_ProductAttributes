...
$files = [
    ...
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductCustomAttributesDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductModifiersDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductFulfillmentDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductCategoryHierarchyDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductShippingClassesDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductCartRulesDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductRelatedProductsDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Dao/ProductMeasurementUnitsDao.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Service/ProductAttributeExportReader.php',
    ...
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/UpsertProductIdentifiersAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/CloneIdentifiersToVariationsAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/UpsertProductLifecycleAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/CloneLifecycleToVariationsAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/UpsertTagAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/DeleteTagAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/AddTagAssignmentAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/RemoveTagAssignmentAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/AddProductMediaAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/DeleteProductMediaAction.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/Actions/SetMediaVariationLinksAction.php',
    ...
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/UI/IdentifiersClonePanel.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/UI/ProductLifecycleTab.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/UI/LifecycleClonePanel.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/UI/ProductTagsTab.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/UI/ProductMediaTab.php',
    __DIR__ . '/../src/Ksfraser/FA_ProductAttributes/UI/ProductAttributesSummaryTab.php',
];
