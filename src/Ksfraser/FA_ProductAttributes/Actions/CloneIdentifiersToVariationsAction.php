...
/**
 * Single Responsibility: Copies a parent product's identifier data to a
 ...
 */
class CloneIdentifiersToVariationsAction
{
    ...
    public function handle(array $postData): string
    {
        ...
        if ($parentData === null) {
            return 'Parent product has no identifier data to clone';
        }
        ...
        return sprintf(_('%d variation(s) updated with parent identifier data'), $count);
    }
}
